...
<a href="/static/docattachment/动火安全作业证.pdf" target="_blank">pdf模板查看</a>，

<a href="/static/docattachment/动火安全作业证输出.pdf" target="_blank">pdf输出结果查看</a>

## EOC报表详情Word显示

  ![EOC](/static/docimg/EOC展示.png)

  ![Word输出](/static/docimg/Word输出.png)
