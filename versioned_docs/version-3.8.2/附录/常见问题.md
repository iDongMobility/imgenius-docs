...
![wenti](/static/docimg/wenti1.png)
...
![wenti](/static/docimg/wenti2.png)
...
![wenti](/static/docimg/wenti5.png)
...
![wenti](/static/docimg/wenti3.png)

**解决办法：** 重新创建用户，不要使用域用户。

**Win10系统：** 控制面板-程序-打开或关闭windows功能，打开IISasp

![wenti](/static/docimg/wenti4.png)
...
* SMC部署时，报错-指定账户没有权限或者此节点文件被锁定。
    ...
    ![wenti](/static/docimg/wenti9.png)

    3. 确定盘符c已被共享。

    ![wenti](/static/docimg/wenti10.png)

    4. 确定SMC-计算机名或IP地址配置正确。

    ![wenti](/static/docimg/wenti11.png)
...
![wenti](/static/docimg/wenti8.png)
