...
![1](/static/docimg/作业组属性-基本信息.png)
...
* 此分组为报警参数具体配置，钛准定位系统会读取这些作业组属性。
  ...
  ![1](/static/docimg/报警具体设置.png)

  ![钛准系统报警](/static/docimg/钛准系统报警.png)
...
![1](/static/docimg/钛准显示1.png)

### 作业申请审核

![1](/static/docimg/申请审核.png)

![1](/static/docimg/钛准显示2.png)
...
![1](/static/docimg/终端显示1.png)

### 气体检测

![1](/static/docimg/终端显示2.png)

* 检测合格后每半小时会创建一个气体检测作业组。

  ![1](/static/docimg/计划气体检测.png)
...
![1](/static/docimg/暂停成功.png)

![1](/static/docimg/钛准已完成.png)
