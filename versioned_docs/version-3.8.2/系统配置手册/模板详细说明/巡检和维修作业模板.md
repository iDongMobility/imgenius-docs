...
![1](/static/docimg/流程.png)

### <span id="zypz">作业配置</span>

* *设备交出*作业对应*201技师班交出设备*活动，作业项就是一个交出的签名，没有其他具体作业内容。
![1](/static/docimg/作业对应1.png)

* *维修执行*对应*电仪维修*或*机械维修*。
![1](/static/docimg/作业对应2.png)
...
![1](/static/docimg/交出要求.png)

* 工艺安全措施
  * 此分组主要是活动*工艺员审核*时填写。方便技师交出时查看注意事项。
![1](/static/docimg/工艺安全措施.png)

* 系统
  * 此分组为系统内部使用，不管是执行人还是审核人员都不需要查看。
![1](/static/docimg/系统.png)
...
<a href="/static/docattachment/维修一览表.zip" target="_blank">下载包文件</a>

* 本质上为作业组属性展示报表。将*基本信息*分组的作业组属性在一行内显示出来，这样就能清洗展示一段时间内的所有维修情况。
![1](/static/docimg/维修一览表.png)

#### <span id="number&time">设备的维修时间及次数</span>

<a href="/static/docattachment/设备的维修时间及次数.zip" target="_blank">下载包文件</a>

* 按照纬度为**天**统计维修时间和维修次数。
![1](/static/docimg/维修时间次数.png)

#### <span id="TOP10">维修TOP10</span>

<a href="/static/docattachment/维修TOP10.zip" target="_blank">下载包文件</a>

* 已纬度*资产*计算一段时间内最多维修时间和次数的设备排名形成报表。
![1](/static/docimg/维修TOP10.png)

#### <span id="ljqk">更换零件情况</span>

* 本质上是作业项历史报表分析。将**表格**格式转化为**图表**格式。一段时间内的有记录的更换零件数量形成饼图。
![1](/static/docimg/更换零件情况2.png)

<a href="/static/docattachment/更换零件情况.zip" target="_blank">下载包文件</a>

![1](/static/docimg/更换零件情况.png)

#### <span id="ycfx">维修异常分析</span>

<a href="/static/docattachment/维修异常分析.zip" target="_blank">下载包文件</a>

![1](/static/docimg/维修异常分析.png)
...
1. 很多作业组属性是由计划人填写。
![1](/static/docimg/计划维修1.png)

2. *设备交出*作业执行时，会选择具体的维修设备（系统内资产）。
![2](/static/docimg/计划维修2.png)

## 报修-维修作业组

* 此作业组是终端按需创建产生的作业组。

  ![1](/static/docimg/按需维修1.png)