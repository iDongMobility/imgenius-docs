...
* 终端点击审核，进入待审核，点击审核
 ...
 <img alt=" " src={useBaseUrl('docimg/待审核1.jpg')} />

 * 审核界面，作业组详细信息

 <img alt=" " src={useBaseUrl('docimg/待审核2.jpg')} />

 * 可以输入审核意见，作业组批准，退货，后退，终止都可以

 <img alt=" " src={useBaseUrl('docimg/待审核3.jpg')} />
...
* 其中SpecialView为特殊视图赋予了单独点击单独下载的功能，而SpecialViewBatchExport会在功能栏增加一个批量下载按钮，可以将当前页面的特殊视图批量导出，并带有导出进度条，导出的文件名称为作业组名称+视图模板名称+创建时间。
