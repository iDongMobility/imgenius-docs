...
1. [implus-222:作业组属性，每个分组的属性栏都锁定，类似于excel的首行冻结](implus-222作业组属性每个分组的属性栏都锁定类似于excel的首行冻结)
...
* 左侧菜单新增加了作业管理，系统-系统角色，和高级。作业管理中包括作业组模板和作业规范。系统-系统角色中，可以进行粒度更细的权限控制。高级中，将关联关系引擎移植了过来，无需进行额外的配置。
...
### implus-222:作业组属性，每个分组的属性栏都锁定，类似于excel的首行冻结
