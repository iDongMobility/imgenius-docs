...
```js
var resultName = ScriptEngine.GetResultName();
var userName= ScriptEngine.Context.GetTaskGroupPropertyValue('维修人');//获取名为维修人的作业组属性的值
ScriptEngine.GetAjaxToApiServer('UserConfig', 'GetID', 'loginName=' + userName, '', 'get', function (userID) {
    if (userID) {
        ScriptEngine.GetAjaxToApiServer('UserConfig', 'GetRoles', 'userID=' + userID, '', 'get', function (_result) {
            if (_result && _result.length > 0 && _result[0]['RelatedOrgUnit']) {
                var orgUnitName = _result[0]['RelatedOrgUnit']['Name'];
                ScriptEngine.Context.SetTaskGroupPropertyValue('维修人组织单元', orgUnitName)//赋值到作业组属性维修人组织单元中
            }
            ScriptEngine[resultName] = '';
    } else {
        ScriptEngine[resultName] = '';
